            ...
            <div className="space-y-1.5">
              {list.map((c) => (
                <div
                  ...
                  className={`flex flex-wrap items-start gap-x-3 gap-y-1 rounded-lg border px-3 py-2 text-sm bg-white border-gray-200 ${
                ...
                >
                  ...
                  <span className="flex-1 text-gray-700 basis-full md:basis-auto">
                    {c.detail}
                  </span>
                </div>
              ))}
