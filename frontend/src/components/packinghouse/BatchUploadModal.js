          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div className={`flex-1 overflow-y-auto p-4 ${showPdfPanel ? 'w-1/2' : 'w-full'}`}>
              ...
              <div className="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg mb-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Field/Block {(stmt.statement_type === 'packout' || stmt.statement_type === 'wash_report') && '*'}
                  </label>
                  <select
                  ...
                  >
                    <option value="">
                      {stmt.statement_type === 'settlement' || stmt.statement_type === 'grower_statement'
              ...
              {stmt.id && expandedStatements[stmt.id] && stmt.status === 'extracted' && (
                <div className="px-4 pb-4 pt-2 border-t border-gray-200 bg-white">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      <label className="block text-xs font-medium text-gray-700 mb-1">Field/Block</label>
                      <select
                      ...
                      >
                        <option value="">{stmt.statement_type === 'settlement' ? 'Grower Summary' : '-- Select Field --'}</option>
