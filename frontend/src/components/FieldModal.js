    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900">{field ? 'Edit Field' : 'Add Field'}</h2>
          <button onClick={onClose} className="p-2 hover:bg-gray-100 rounded-lg text-gray-500"><X size={24} /></button>
        </div>
        ...
        <div className="p-6 space-y-4">
          ...
          {activeTab === 'basic' && (
            <>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Field Name *</label>
                  <input type="text" value={formData.name} onChange={(e) => setFormData({...formData, name: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., North Block A" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Field Number</label>
                  <input type="text" value={formData.field_number} onChange={(e) => setFormData({...formData, field_number: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., F-001" />
                </div>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <select value={formData.farm} onChange={handleFarmChange} className="w-full p-2 border border-blue-300 rounded-lg bg-white text-gray-900">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Acres *</label>
                  <input type="number" step="0.01" value={formData.total_acres} onChange={(e) => setFormData({...formData, total_acres: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., 25.5" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">County * <span className="text-xs font-normal text-gray-500">(Required for PUR)</span></label>
                  <select value={formData.county} onChange={(e) => setFormData({...formData, county: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900">
          ...
          {activeTab === 'crop' && (
            <>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Crop *</label>
                  <select
                    value={formData.crop}
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Rootstock</label>
                  <select
              ...
              {crops.length === 0 && (
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Crop (Text) *</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Planting Date</label>
                  <input type="date" value={formData.planting_date} onChange={(e) => setFormData({...formData, planting_date: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Year Planted</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Organic Status</label>
                  <select
                ...
                {formData.organic_status === 'certified' && (
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-900">Certifier</label>
                    <input
                      type="text"
              ...
              {formData.organic_status === 'certified' && (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-900">Certificate Number</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-900">Certificate Expiration</label>
                    <input
                      type="date"
          ...
          {activeTab === 'spacing' && (
            <>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Row Spacing (ft)</label>
                  <input
                    type="number"
                    step="0.1"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Tree/Plant Spacing (ft)</label>
                  <input
                    type="number"
                    step="0.1"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Tree/Plant Count</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Trees per Acre</label>
                  <input
                    type="number"
                    step="0.01"
              ...
              <CollapsibleSection title="Layout & Yield Estimates">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-900">Row Orientation</label>
                    <select
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-900">Trellis System</label>
                    <select
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-900">Expected Yield per Acre</label>
                    <input
                      type="number"
                      step="0.01"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1 text-gray-900">Yield Unit</label>
                    <select
          ...
          {activeTab === 'soil' && (
            <>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Soil Type</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Irrigation Type</label>
                  <select
          ...
          {activeTab === 'location' && (
            <>
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Section</label>
                  <input type="text" value={formData.plss_section} onChange={(e) => setFormData({...formData, plss_section: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., 12" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Township</label>
                  <input type="text" value={formData.plss_township} onChange={(e) => setFormData({...formData, plss_township: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., 15S" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">Range</label>
                  <input type="text" value={formData.plss_range} onChange={(e) => setFormData({...formData, plss_range: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., 18E" />
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">GPS Latitude</label>
                  <input type="text" value={formData.gps_latitude} onChange={(e) => setFormData({...formData, gps_latitude: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., 36.7378" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-900">GPS Longitude</label>
                  <input type="text" value={formData.gps_longitude} onChange={(e) => setFormData({...formData, gps_longitude: e.target.value})} className="w-full p-2 border rounded-lg bg-white text-gray-900" placeholder="e.g., -119.7871" />
                </div>
              </div>
            </>
          )}
        ...
        <div className="p-6 border-t flex gap-3 justify-end">
          <button onClick={onClose} className="px-6 py-2 border rounded-lg hover:bg-gray-50 text-gray-700">Cancel</button>
