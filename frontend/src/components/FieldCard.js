    ...
    >
      ...
      <div className="hidden sm:flex gap-2 pt-3 border-t border-gray-100" onClick={e => e.stopPropagation()}>
        ...
        {hasBoundary && (
          <>
            <button
              ...
              className="flex items-center justify-center gap-1 px-3 py-1.5 bg-purple-50 text-purple-600 rounded hover:bg-purple-100 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1 px-3 py-1.5 bg-emerald-50 text-emerald-600 rounded hover:bg-emerald-100 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500"
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1 px-3 py-1.5 bg-blue-50 text-blue-600 rounded hover:bg-blue-100 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
          <Edit size={14} />
          Edit
        </button>
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1 px-3 py-1.5 bg-red-50 text-red-600 rounded hover:bg-red-100 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-red-500"
        >
          <Trash2 size={14} />
          Delete
        </button>
      ...
      <div className="flex sm:hidden gap-2 pt-3 border-t border-gray-100" onClick={e => e.stopPropagation()}>
        ...
        <div className="relative" ref={mobileMenuRef}>
          <button
            ...
            className="p-2 bg-gray-50 text-gray-600 rounded hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-primary"
            title="More actions"
