    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 text-sm font-medium text-green-700 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300 ml-auto"
        >
          Go Fix
...
const QuickWinCard = ({ item, onNavigate }) => (
  <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow">
    ...
    <button
      onClick={() => onNavigate(item.tab)}
      className="inline-flex items-center gap-1 text-sm font-medium text-green-700 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300"
    >
      Finish Up
      <ArrowRight className="w-3.5 h-3.5" />
    </button>
        ...
        <div className="space-y-4">
          ...
          {progress_pipeline?.compliant > 0 && (
            <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-lg p-4 text-center">
              <Sparkles className="w-6 h-6 text-green-600 dark:text-green-400 mx-auto mb-1" />
