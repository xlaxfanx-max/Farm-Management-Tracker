      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg mx-4 max-h-[85vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div className="flex items-center gap-2">
            <Copy className="w-5 h-5 text-primary dark:text-green-400" />
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
                  ...
                  {COPYABLE_MODULES.map((mod) => (
                    ...
                    >
                      <input
                        ...
                        className="w-4 h-4 mt-0.5 rounded border-gray-300 text-primary focus:ring-primary flex-shrink-0"
                      />
          ...
          {step === 'done' && result && (
            <div className="space-y-4">
              <div className="p-4 bg-primary-light dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-center">
        ...
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0 bg-white dark:bg-gray-800 rounded-b-xl">
          ...
          {step === 'done' && (
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2 text-sm bg-primary text-white rounded-lg hover:bg-primary-hover transition-colors font-medium"
            >
